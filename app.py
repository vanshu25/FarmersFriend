...
def screen_result():
    ...
    if escalate or severity in ["HIGH", "CRITICAL"]:
        ...
        # Build symptom summary lines from answers for the report
        answers = st.session_state.answers
        symptom_lines = []
        ...
        <div style="background:white; border:1.5px solid #e0d5c5; border-radius:14px;
          ...
          <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:16px;">
            <div>
              <div style="font-size:17px; font-weight:800; color:#2d4a1e;">
          ...
          <div style="border-top:1px solid #f0ebe0; padding-top:14px; margin-bottom:14px;">
            <div style="font-size:13px; font-weight:700; color:#6b7c61; 
                        letter-spacing:0.05em; margin-bottom:8px;">ANIMAL</div>
            <div style="color:#2d4a1e; font-size:15px;">
              {animal_label}{chicken_label}
            </div>
          </div>

          <div style="border-top:1px solid #f0ebe0; padding-top:14px; margin-bottom:14px;">
            <div style="font-size:13px; font-weight:700; color:#6b7c61;
                        letter-spacing:0.05em; margin-bottom:8px;">SYMPTOMS REPORTED</div>
            <ul style="margin:0; padding-left:18px; color:#2d4a1e; font-size:14px; line-height:1.8;">
              {symptoms_html}
            </ul>
          </div>
          ...
          <div style="border-top:1px solid #f0ebe0; padding-top:14px; margin-bottom:14px;">
            <div style="font-size:13px; font-weight:700; color:#6b7c61;
                        letter-spacing:0.05em; margin-bottom:8px;">POSSIBLE CONDITIONS</div>
            <ul style="margin:0; padding-left:18px; color:#2d4a1e; font-size:14px; line-height:1.8;">
              {conditions_html}
            </ul>
          </div>
          ...
          <div style="border-top:1px solid #f0ebe0; padding-top:14px;">
            <div style="font-size:13px; font-weight:700; color:#6b7c61;
                        letter-spacing:0.05em; margin-bottom:8px;">VET SUMMARY</div>
            <div style="color:#2d4a1e; font-size:14px; line-height:1.7;
                        background:#f8f6f0; border-radius:8px; padding:12px 14px;">
